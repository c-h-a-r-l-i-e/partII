...
In order to filter out a lot of this noise, we use filters that remove
frequencies we know are irrelevant. We know the heartbeat can vary from 
30 to 220 BPM, and hence we would like to disregard any noise at another
frequency.
% TODO: more detail/cite sources

There are various different filters which have been designed for different
uses.
