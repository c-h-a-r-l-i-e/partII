...
\begin{enumerate}
	...
	\item Update step - when we get a confirmed measurement from the
...
\ldots TODO: compare time, show a plot
...
The reason the errors differ so much can be seen in Figure \ref{}<++>
