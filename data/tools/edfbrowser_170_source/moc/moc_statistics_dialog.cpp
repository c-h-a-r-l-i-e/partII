...
struct qt_meta_stringdata_UI_StatisticWindow_t {
    QByteArrayData data[4];
    char stringdata0[53];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_UI_StatisticWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_UI_StatisticWindow_t qt_meta_stringdata_UI_StatisticWindow = {
    {
QT_MOC_LITERAL(0, 0, 18), // "UI_StatisticWindow"
QT_MOC_LITERAL(1, 19, 16), // "startSliderMoved"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 15) // "stopSliderMoved"

    },
    "UI_StatisticWindow\0startSliderMoved\0"
    "\0stopSliderMoved"
};
...
QT_INIT_METAOBJECT const QMetaObject UI_StatisticWindow::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_UI_StatisticWindow.data,
    qt_meta_data_UI_StatisticWindow,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *UI_StatisticWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_UI_StatisticWindow.stringdata0))
