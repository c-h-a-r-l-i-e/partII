...
QT_MOC_LITERAL(3, 23, 14), // "SpecialButton*"
QT_MOC_LITERAL(4, 38, 8), // "setColor"
QT_MOC_LITERAL(5, 47, 5), // "color"
QT_MOC_LITERAL(6, 53, 14), // "setGlobalColor"
QT_MOC_LITERAL(7, 68, 11), // "globalColor"
QT_MOC_LITERAL(8, 80, 7), // "setText"
QT_MOC_LITERAL(9, 88, 11) // "const char*"

    },
    "SpecialButton\0clicked\0\0SpecialButton*\0"
    "setColor\0color\0setGlobalColor\0globalColor\0"
    "setText\0const char*"
};
...
void SpecialButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SpecialButton::*)(SpecialButton * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SpecialButton::clicked)) {
                *result = 0;
                return;
            }
        }
